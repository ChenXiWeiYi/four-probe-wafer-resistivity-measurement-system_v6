...
void Widget::Measure_Start(void)
{
    ...
    SetOptionalLabelText("lblMeasureStartTime", MeasureState_used.Time_MeasurementStart);
    SetOptionalLabelText("lblDataSavePath", QCoreApplication::applicationDirPath() + "/Data/");
